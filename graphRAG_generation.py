...
from neo4j_env import graph, GEMINI_API_KEY
import textwrap
...
{schema}
if question say Talleyrand it means Charles-Maurice de Talleyrand 
...
class GraphRAG:
    def __init__(self):
        ...
        self.cypher_chain = GraphCypherQAChain.from_llm(
            ChatGoogleGenerativeAI(model="gemini-2.0-flash", temperature=0, google_api_key=GEMINI_API_KEY),
            graph=graph,
            verbose=True,
